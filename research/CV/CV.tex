...
\begin{itemize}
    ...
    (Bachelor's Intern at the Research Unit, leading to a conference publication)
    \item Alexander Pluska,  TU Wien, Austria\\ (Supervised in a graduate course, leading to a conference publication)
\end{itemize}

\section*{Teaching Experience \small}
