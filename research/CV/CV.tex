...
I am interested in safe, explainable, and efficient machine learning. My work leverages and advances methods in logic and probability for applications in safety certification of ML models, logic-based explainability and interpretability, provably correct learning and reasoning on relational data, and novel models for neurosymbolic AI.
%\newpage

\section*{Awards and Funding}
\begin{itemize}
    \item \textbf{Honorable Mention Award} at the International Conference on Principles of Knowledge Representation and Reasoning 2024 
    \item \textbf{Best Paper Award} at the International Conference on Neural-Symbolic Learning and Reasoning 2024 
    ...
    % \item \textbf{Half-day Tutorial} at KR 2024 as a \textbf{solo-presenter}
    % \item Co-supervisor to the runner-up for best Master’s thesis at TU Wien in 2025
    \item ANR-FWF joint project \say{Nanostructure evolution in oxide materials at high temperature investigated with advanced X-ray scattering and machine learning based data analysis} 
    \textbf{Role:} Part of the project team, contributed significantly to writing the machine learning work packages. Total Funding: 1,008,858€. Funding for our group: 215,492€
\end{itemize}
...
\years{2026} Steve Azzolin, Stefano Teso, Bruno Lepri, Andrea Passerini, and \textbf{Sagar Malhotra}\\
...
\href{https://openreview.net/forum?id=HBcgLe6NZD}{ICLR 2026}(CORE Rank \textbf{A$^{*}$}, \textbf{28.18$\%$} acceptance rate)\\

\years{2025}Alexander Pluska and \textbf{Sagar Malhotra}\\ 
...
\emph{Machine Learning and Knowledge Discovery in Databases (ECML PKDD), Research Track} \\
...
\years{2022}\textbf{Sagar Malhotra} and Luciano Serafini\\
 On Projectivity in Markov Logic Networks \\ \emph{Machine Learning and Knowledge Discovery in Databases (ECML PKDD), Research Track} \\  
...
\years{2021}\textbf{Sagar Malhotra} and Luciano Serafini\\
 A Combinatorial Approach to Weighted Model Counting in the Two Variable Fragment with Cardinality Constraints\\ \emph{International Conference of the Italian Association for Artificial Intelligence 2021 (AIxIA)}\\
...
\href{https://sites.google.com/view/nesy2023/home/nesy2023-programme-outline?authuser=0}{NeSy 2023} (\textbf{Accepted for spotlight presentation in the recently published track})
% \years{2022}\textbf{Sagar Malhotra} and Luciano Serafini\\
...
\textbf{Invited talk}\\ 
\emph{Aachen Symposium on Representation Learning to Act and Plan, 2025}\\ 
...
\textbf{Half-day tutorial (solo presenter, selection through peer-review)}\\
\emph{International Conference on Principles of Knowledge Representation and Reasoning, 2024} \\
...
\textbf{Invited talk}\\
\emph{MLDM Workshop at the AIxIA Conference 2024, Bolzano, Italy }\\
...
\textbf{Research seminar (invited)}\\
\emph{Institute of Informatics, Ludwig Maximilian University of Munich, Germany}\\  \\
\years{2022}A Tutorial on Probabilistic Inference in Logical Domains\\ 
\textbf{Guest Lecture}\\
\emph{Guest Lecture at the Knowledge representation and Learning course, University of Padova, Italy}\\ \\
...
PC Member for AAAI 23-25, KR 23-26, ECAI-25-26 and IJCAI 24-26

Reviewer for ICML 24-26, ICLR 24-25, NeurIPS 23-25, AISTATS 23-25, ICALP 2025, NeSy 2025-26
...
\subsection*{Master's thesis (co-)supervision}
...
\textbf{Runner-up for Best Master Thesis Award}\\
...
\subsection*{Other Student Supervision Roles}
    ...
    Role: Supervised in a graduate course, leading to an award-winning publication at KR 2024\\ 
...
\years{2025W - Now} \textbf{Neurosymbolic Reasoning (VU, 6 ECTS, MSc. and Ph.D., TU Wien)}\\
\textbf{Role:} Teaching and designing the first edition of the course with Prof. Thomas Eiter. I am responsible for covering: foundational ideas in probabilistic logic; fuzzy logic; maximum entropy distributions; probabilistic NeSy models like semantic loss and semantic probabilistic layer; fuzzy NeSy models like logic tensor networks and Knowledge enhanced NNs. \\  

\newpage


\years{2025S- Now}\textbf{Modern Applications of Logic in Machine Learning (VU, 3 ECTS, MSc. and Ph.D., TU Wien)}\\ 
\textbf{Role:}  Responsible for creating and teaching the entire course as a \textbf{solo instructor}. 
...
% \newpage
\years{2023W - Now} \textbf{Introduction to Machine Learning (VU, 6 ECTS, B.Sc. $\sim$100 Students, TU Wien)}\\
\textbf{Role:} Part of the team that designed the first edition of the course, responsible for creating and teaching the module on Probabilistic ML.\\ 
% I also taught the lectures for Probabilistic Machine Learning and was responsible for the office hours for various modules of the course. I developed automatically graded python based exercises that gave students hands-on experience. Also wrote a large question bank for the theoretical exam. \\ 

% \newpage

 \years{2023W - Now} \textbf{Theoretical Foundations and Research Topics in Machine Learning\\ (VU, 3 ECTS, M.Sc. and Ph.D., TU Wien)}\\
 \textbf{Role:} Partially responsible for conducting interactive exercise sessions involving concepts from ML, like PAC learning, Kernel methods and GNNs.\\

 \years{2023W - Now} \textbf{Machine Learning Algorithms and Applications
(PR, 3 ECTS, M.Sc. and Ph.D., TU Wien)}\\
\textbf{Role:} This is a project based course organized by our research unit. I have consistently offered new projects in this course. One of the offered projects led to an award-winning publication with a student, Alexander Pluska, at KR 2024. \\ 

 \years{2023W - Now} \textbf{Scientific Research and Writing (SE, 3 ECTS, B.Sc., TU Wien)}\\ 
 \textbf{Role:} This course is part of the TU Wien scientific writing course. For the practical part of the course, our research unit offers many research topics to students to write a report.
 I organize a mock-conference and peer-review procedure on EasyChair for the course.  \\

 \years{2025W-Now} \textbf{Teaching Co-ordinator for Machine Learning Research Unit, TU Wien}\\
 \textbf{Role:} Responsible for managing the teaching coordination between the Machine Learning Research Unit and the deans of education at TU Wien. 
%  Learning to navigate administrative aspects of organizing teaching hours for the research unit.
...
\begin{multicols}{2}
{\small Prof. Thomas Gärtner (PostDoc Host)\\
% Head of Unit\\
Head of Machine Learning Research Unit\\
TU Wien, Vienna, Austria\\
Email: \href{mailto: thomas.gaertner@tuwien.ac.at}{thomas.gaertner@tuwien.ac.at} \\

Prof. Luciano Serafini (PhD Supervisor)\\
% Head of Unit\\
Head of Data and Knowledge Management Unit\\
Fondazione Bruno Kessler, Trento, Italy\\
Email: \href{mailto: serafini@fbk.eu}{serafini@fbk.eu} \\ 

Prof. Andrea Passerini (Collaborator)\\ 
% Relationship: Collaborator on GNN explainability \\
...
{\small
Prof. Thomas Eiter (Co-Lecturer)\\ 
% Relationship: Collaborator on GNN explainability \\
Head of Logic and Computation Institute\\
and Knowledge-Based Systems Research Unit \\
TU Wien, Vienna, Austria\\ 
Email: \href{mailto: thomas.eiter@tuwien.ac.at}{thomas.eiter@tuwien.ac.at} \\ 

Prof. Hector Geffner\footnotemark[1] \\
Alexander von Humboldt Professor\\
Chair of Machine Learning and Reasoning\\
RWTH Aachen University, Germany\\
Email: \href{mailto: hector.geffner@ml.rwth-aachen.de}{hector.geffner@ml.rwth-aachen.de} \\ 

Prof. Magdalena Ortiz\footnotemark[1]\\
Knowledge-Based Systems Research Unit\\
TU Wien, Vienna, Austria\\
Email: \href{mailto: magdalena.ortiz@tuwien.ac.at}{magdalena.ortiz@tuwien.ac.at}
}
...
% \end{center}
\end{multicols}
\footnotetext[1]{Not close collaborators.}
\end{document}
