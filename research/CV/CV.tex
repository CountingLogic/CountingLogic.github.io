...
\begin{itemize}
    ...
    \item Project titled \say{Logical Distillation of Machine Learning Models} among 21/84 funding applications invited to the long proposal phase for WWTF ICT funding (Under Review, Role: Principal Investigator, Funding requested: 793,884.00 €)
...
\emph{Invited Talk at MLDM Workshop at the AIxIA Conference 2024, Bolzano, Italy }\href{https://sites.google.com/view/mldm2024/program?authuser=0}{MLDM}\\ \\
...
\years{2025-} Michael Pritz,  TU Wien, Austria\\
Thesis title (tentative): Mechanistic Interpretability of Transformers\\ 
\\
...
\section*{Other Student Supervision Roles}
    \years{2024} Florian Chen, TU Wien, Austria\\
    (Co-supervised in a student internship,\\ leading to a conference publication at ECML PKDD 2024)\\
    % \newpage
